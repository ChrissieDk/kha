      ...
      <div className="flex items-center justify-center min-h-screen p-4">
        ...
        <div className="bg-gray-200/5 backdrop-blur-lg rounded-2xl p-8 md:p-10 max-w-4xl w-full">
          <div className="flex flex-col items-center text-center">
            <h1 className="text-4xl sm:text-6xl md:text-8xl p-2 sm:p-3 md:p-4 font-bold mb-4 sm:mb-6 md:mb-8 bg-gradient-to-r from-green-400 via-blue-500 to-pink-500 bg-clip-text text-transparent">
              Knowledge Hub
              <br />
              Arabia
            </h1>

            <p className="text-gray-400 text-lg sm:text-xl md:text-2xl mb-6 sm:mb-8 md:mb-12 max-w-lg">
              Saudi Arabia's Leading
              <br />
              Online Academic{" "}
              <span className="inline-block min-w-[2ch]">{typingWord}</span>
            </p>
            ...
            <div className="flex items-center max-w-md w-full">
              ...
              />
              <button className="bg-white text-black px-4 sm:px-6 py-2 sm:py-3 rounded-r-lg font-medium text-sm sm:text-base">
                Notify Me
              </button>
            </div>
